/*
 * Healthcare Management System - Windows Compatible Version
 * This version is optimized for Windows compilation and execution
 * Includes Windows-specific headers and console setup functions
 *
 * Compilation: g++ -o healthcare.exe forwindowsmain.cpp
 * Execution: healthcare.exe
 */
...
// Windows-specific headers for better compatibility
#ifdef _WIN32
#include <windows.h>
#include <conio.h>
#include <io.h>
...
void clearScreen()
{
    ...
    system("cls");
    // Alternative method using Windows API (more efficient)
...
// Windows console setup function for better compatibility
void setupWindowsConsole()
{
#ifdef _WIN32
    // Set console to UTF-8 encoding for better character support
    ...
    // Set console title
    SetConsoleTitleA("Healthcare Management System");
#endif
}
...
#ifdef _WIN32
    // Use Windows-specific getch() if available
    while (_kbhit())
        _getch(); // Clear any pending input
    _getch();
#else
...
int main()
{
    // Setup Windows console for better compatibility
    setupWindowsConsole();
